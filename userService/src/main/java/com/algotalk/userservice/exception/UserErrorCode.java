...
public enum UserErrorCode implements ErrorCode {
    ...
    FIND_PASSWORD_SESSION_EXPIRED   ("USER_032", "비밀번호 재설정 요청이 만료되었거나 유효하지 않습니다.", HttpStatus.GONE),
    PASSWORD_RESET_FAIL             ("USER_033", "비밀번호 재설정 처리 중 오류가 발생했습니다.", HttpStatus.BAD_REQUEST),
    // 로그인 정보 수정
    CUR_PASSWORD_MISMATCH           ("USER_034", "현재 비밀번호가 일치하지 않습니다.", HttpStatus.BAD_REQUEST),
    NOW_PASSWORD_SAME               ("USER_035", "현재 비밀번호와 동일한 비밀번호로 변경할 수 없습니다.", HttpStatus.BAD_REQUEST),
    PASSWORD_ALREADY_SET            ("USER_036", "이미 비밀번호가 설정된 계정입니다.", HttpStatus.BAD_REQUEST),
    PASSWORD_UPDATE_FAIL            ("USER_037", "비밀번호 변경이 실패했습니다.", HttpStatus.BAD_REQUEST),
    NICKNAME_UPDATE_FAIL            ("USER_038", "닉네임 변경이 실패했습니다.", HttpStatus.BAD_REQUEST),
    EMAIL_UPDATE_FAIL               ("USER_039", "이메일 변경이 실패했습니다.", HttpStatus.BAD_REQUEST),
    NAME_UPDATE_FAIL                ("USER_040", "이름 변경이 실패했습니다.", HttpStatus.BAD_REQUEST),
    ADDR_UPDATE_FAIL                ("USER_041", "주소 변경이 실패했습니다.", HttpStatus.BAD_REQUEST),
    WITHDRAW_FAIL                   ("USER_042", "회원 탈퇴 처리에 실패했습니다.", HttpStatus.BAD_REQUEST),
    WITHDRAW_PASSWORD_REQUIRED      ("USER_043", "비밀번호 가입 회원은 현재 비밀번호 입력이 필요합니다.", HttpStatus.BAD_REQUEST),
