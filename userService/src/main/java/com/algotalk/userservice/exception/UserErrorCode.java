...
public enum UserErrorCode implements ErrorCode {
    ...
    NICKNAME_UPDATE_FAIL            ("USER_036", "닉네임 변경이 실패했습니다.", HttpStatus.BAD_REQUEST),
    EMAIL_UPDATE_FAIL               ("USER_037", "이메일 변경이 실패했습니다.", HttpStatus.BAD_REQUEST),
    NAME_UPDATE_FAIL                ("USER_038", "이름 변경이 실패했습니다.", HttpStatus.BAD_REQUEST),
    ADDR_UPDATE_FAIL                ("USER_039", "주소 변경이 실패했습니다.", HttpStatus.BAD_REQUEST),
