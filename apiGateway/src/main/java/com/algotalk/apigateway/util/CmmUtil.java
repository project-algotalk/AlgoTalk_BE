package com.algotalk.apigateway.util;
...
public class CmmUtil {
	...
	public static String nvl(Long num, String chg_str) {
		return (num == null) ? chg_str : num.toString();
	}

	public static String nvl(Long num) {
		return nvl(num, "");
	}
